...
int main ()
{
    ...
    cout<<ans<<endl  ;
    int LB = lower_bound(v.begin(), v.end(), 6)- v.begin() ;  ///wil return the 1st index that is >= 2
    cout<<LB<<endl ;
    int UP = upper_bound(v.begin(), v.end(), 6) - v.begin() ;  ///will return the 1st index that is > 12
    cout<<UP<<endl ;
    return 0 ;
}
